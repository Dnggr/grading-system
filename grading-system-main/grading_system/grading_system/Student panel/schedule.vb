...
Public Class schedule
    ...
    Private Sub LinkLabel2_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles LinkLabel2.LinkClicked
        ...
        "WHERE section.section_id = ? " & _
        "AND subject.course_id = ? " & _
        "AND sem.semester = 2", con)

            cmd.Parameters.AddWithValue("?", login_logic.secid)
            cmd.Parameters.AddWithValue("?", login_logic.Courseid)
            cmd.Parameters.AddWithValue("2", login_logic.currentsem)
            Dim da As New OdbcDataAdapter(cmd)
            Dim dt As New DataTable
